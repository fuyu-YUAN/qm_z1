...
public:
      ...
      eeCmdVelToTargetTrajectories_(std::move(eeCmdVelToTargetTrajectories))
    {
        ...
        BarrierHandler_.insert("Send barrier 1 pose", boost::bind(&QmTargetTrajectoriesInteractiveMarker::process1Feedback, this, _1));
...
private:
    ...
    geometry_msgs::Point barriermsg,ee_pos;  
    ...
    ros::Publisher obstacle_ballPublisher_,ee_pos_pub;
