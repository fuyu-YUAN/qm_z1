...
visualization_msgs::InteractiveMarker QmTargetTrajectoriesInteractiveMarker::createInteractiveMarker() const {
    ...
    interactiveMarker.pose.orientation.x = -0.01;
    interactiveMarker.pose.orientation.y = 0.7;
    interactiveMarker.pose.orientation.z = -0.01;
    interactiveMarker.pose.orientation.w = 0.7;
...
visualization_msgs::InteractiveMarker QmTargetTrajectoriesInteractiveMarker::BarrierMarker() const {
  visualization_msgs::InteractiveMarker interactiveMarker;
  interactiveMarker.header.frame_id = "world";
  interactiveMarker.header.stamp = ros::Time::now();
...
void QmTargetTrajectoriesInteractiveMarker::process1Feedback(const visualization_msgs::InteractiveMarkerFeedbackConstPtr& feedback) {
